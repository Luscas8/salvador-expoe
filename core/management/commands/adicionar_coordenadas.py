...
class Command(BaseCommand):
    help = 'Adiciona coordenadas aos bairros que estão faltando'

    def handle(self, *args, **options):
        self.stdout.write('Adicionando coordenadas aos bairros...')
        
        # Dicionário com as coordenadas dos bairros
        coordenadas = {
